...
<html lang="fr">
  <head>
    ...
    <title>Jérémy Gauthier</title>
    <meta name="description" content="Bienvenu sur le CV en ligne de Jérémy Gauthier, vous y trouverez toutes les infos concernant mon parcours et mes expériences"/>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="section">
        <div class="container">
          <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon" href="https://www.linkedin.com/in/jeremygauthier11/" rel="tooltip" title="Suivez moi sur linkedin"><i class="fa fa-linkedin"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="https://twitter.com/jimd3v" rel="tooltip" title="Suivez moi sur Twitter"><i class="fa fa-twitter"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="https://github.com/jeremy-gauthier" rel="tooltip" title="Suivez moi sur Github"><i class="fa fa-github"></i></a></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">jeremy.gth.dev@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Mobile:</strong></div>
              <div class="col-sm-8">06 52 63 92 00</div>
            </div>
            <div class="row mt-3">
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Juillet 2020</p>
            <div class="h5">La main au panier</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <br>
          <img src="images/lamainaupanier.png" alt="">
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Janvier 2020</p>
            <div class="h5">Site vitrine Wordpress</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>2020</p>
            <div class="h5">Projet Personnel</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
  ...
  <div class="container cc-education">
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
         <p>La formation “Développeur web” prépare au titre professionnel “Développeur Web et Web Mobile” (Bac +2). Toute la formation se déroule en téléprésentiel sur l'environnement Linux avec utilisation quotidienne de terminal et GIT.<br>
          <br>
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
          <br>
         <p>Bachelor Marketing vente (Bac +3) obtenu en 2016 à l'école de commerce ISTEF Toulouse <br><br> <a href="https://www.istef.fr/SVE/Uploads/Fichiers/BACHELOR-MKV.pdf">Lien vers la formation</a></p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <br>
            <p>BTS Management des unités commerciales (Bac +2) obtenu en 2014 à l'école de commerce IDRAC Montpellier <br><br><a href="https://www.cned.fr/inscription/22961dix?gclid=Cj0KCQjwgo_5BRDuARIsADDEntR_3R4R_SkL_Iiaotg56BXqg8HAs_knO9iHx6nz863MrII9senIrsQaAujlEALw_wcB&gclsrc=aw.ds">Lien vers la formation</a></p>
          </div>
        </div>
      </div>
    </div>
